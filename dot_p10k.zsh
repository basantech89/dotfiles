# Generated by Powerlevel10k configuration wizard on 2025-07-01 at 15:31 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ANACONDA_SHOW_ON_COMMAND='conda|jupyter'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='nx|yarn|pnpm|aws|awless|cdk|terraform|pulumi|terragrunt'
  ...
  typeset -g POWERLEVEL9K_AWS_BACKGROUND=227
  typeset -g POWERLEVEL9K_AWS_FOREGROUND=235
