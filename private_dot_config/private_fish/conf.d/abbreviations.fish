...
abbr -a -- pu 'paru -Syu --removemake --cleanafter --needed --noconfirm'
abbr -a -- pm 'sudo pacman-mirrors --fasttrack 20 && sudo pacman -Syyu'
abbr -a -- pma 'sudo pacman-mirrors --country all && sudo pacman -Syuu'
...
abbr -a -- fpaths 'echo $fish_user_paths | tr " " "\\n" | nl'
